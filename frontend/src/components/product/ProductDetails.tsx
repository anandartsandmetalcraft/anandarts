      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
        ...
        <div className="space-y-6">
          <div className="relative group">
            ...
            <div 
               className="aspect-square relative rounded-3xl overflow-hidden bg-white shadow-2xl cursor-crosshair border border-black/5"
            ...
            >
              ...
              <button onClick={(e) => { e.stopPropagation(); nextImg(); }} className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white/80 backdrop-blur shadow-lg flex items-center justify-center text-black opacity-0 group-hover:opacity-100 transition-opacity hover:bg-white">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col gap-6 mb-12">
             {(isLowStock || isOutOfStock) && (
               <div
                 className={`inline-flex items-center gap-2 self-start px-4 py-2 rounded-full font-ui text-[10px] font-extrabold uppercase tracking-widest ${
                   isOutOfStock
                      ...
                      >
                         ...
                         <div className="space-y-8">
                            ...
                            <div className="space-y-2">
                               ...
                               <p className="font-ui text-sm text-[var(--color-brand-char)] font-bold">+91 94812 00456</p>
